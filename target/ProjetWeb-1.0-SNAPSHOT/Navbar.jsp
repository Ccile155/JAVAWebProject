    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
           ...
           <li class="nav-item">
            ...
            <li>
                <a class="nav-link" href="<%=getServletConfig().getServletContext().getContextPath()%>/Recherche"><i class="material-icons">search</i> Rechercher &nbsp;</a>
            </li>
<!--                    <li class="nav-item">
        ...
        <ul class="navbar-nav" style="float:left;">
            <li class="nav-item">
                <a class="nav-link" href="<%=getServletConfig().getServletContext().getContextPath()%>/Meteo"><i class="material-icons">wb_sunny</i><i class="material-icons">filter_drama</i> Météo &nbsp;</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        } else {out.println("<a class='dropdown-item' href='" + getServletConfig().getServletContext().getContextPath() + "/admin.jsp'><i class='material-icons'>settings</i> Paramètres</a>");
